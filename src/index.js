...
const webhooksEnabled = webhook.startLogs.id && webhook.startLogs.token;
let startLogs = null;
let shardLogs = null;
...
if (webhooksEnabled) {
    ...
    shardLogs = new Discord.WebhookClient({
...
if (webhooksEnabled) {
    consoleLogs = new Discord.WebhookClient({
        id: webhook.consoleLogs.id,
        token: webhook.consoleLogs.token,
    });

    warnLogs = new Discord.WebhookClient({
